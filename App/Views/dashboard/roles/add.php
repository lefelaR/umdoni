                ...
                <div class="col-md-6">
                    ...
                    <div class="my-5">
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="eventManagement" name="eventManagement" id="eventManagement"
                                <?= $eventManagement ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="contentManagement" name="contentManagement" id="contentManagement"
                                <?= $contentManagement ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="serviceManagement" name="serviceManagement" id="serviceManagement"
                                <?= $serviceManagement ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="officialProfiles" name="officialProfiles" id="officialProfiles"
                                <?= $officialProfiles ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="documentLibrary" name="documentLibrary" id="documentLibrary"
                                <?= $documentLibrary ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="HumanResources" name="humanResources" id="humanResources" <?= $humanResources ?>>
                            <label class="form-check-label" for="helperText">Human Resources</label>
                        </div>

                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="communityEngagement" name="communityEngagement" id="communityEngagement"
                                <?= $communityEngagement ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="economicDevelopment" name="economicDevelopment" id="economicDevelopment"
                                <?= $economicDevelopment ?>>
                        ...
                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="systemSettings" name="systemSettings" id="systemSettings" <?= $systemSettings ?>>
                            <label class="form-check-label" for="helperText">System Settings</label>
                        </div>

                        <div class="form-switch form-check form-group">
                            <input class="form-check-input" type="checkbox" onclick="handleToggle(event)"
                                data_id="support" name="support" id="support" <?= $support ?>>
